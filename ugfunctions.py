...
def my_dig_plot(msfilename,myfields,myampcals,mypcals,mytargets,mycalsuffix,bptable):
	print msfilename,myfields,myampcals,mypcals,mycalsuffix,bptable
